...
import com.pwb.restaurantManager.repository.database.UserOtpRepository
import com.pwb.restaurantManager.model.entity.UserOtp
import com.pwb.restaurantManager.model.entity.User
import com.pwb.restaurantManager.repository.database.LoginHistoryRepository
import com.pwb.restaurantManager.repository.database.RoleRepository
import com.pwb.restaurantManager.repository.database.RolePrivilegeRepository
import com.pwb.restaurantManager.repository.database.PrivilegeRepository
import com.pwb.restaurantManager.repository.database.ModuleRepository
...
class AuthenticationService(
   ...
   private val environment: Environment
	...
	fun loadAppConfig(): BaseResponse{
		//TODO LOAD MODULES
		val moduleNames = listOf("USER","MENU","ORDER","ORDER_ITEM","USER_OTP","LOGIN_HISTORY","PRIVILEGE","ROLE","ROLE_PRIVILEGE","MODULE","AUDIT_LOG")
